/**
This is the official staking contract of the WifeChangingGame token.
...
contract WifeChangingGameStakes is Ownable, ReentrancyGuard {
    ...
    function setMaxStakingAmount(uint256 amount) external onlyOwner {
